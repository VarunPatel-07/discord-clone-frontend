...
interface ChatsMessageProfileProps {
  id: string;
  SenderId: string;
  Sender: {
    id: string;
...
const ChatsMessageProfile = memo(
  ({
    ConversationsInfo,
    IsDashboard,
    User_Info,
  }: {
    ConversationsInfo: ChatsMessageProfileProps;
    IsDashboard: boolean;
    User_Info: any;
  }) => {
    const { setSelectedOneToOneChatInfo, selectedOneToOneChatInfo } = useContext(Context) as any;
    const HandelTheStateChangeByClick = (Conversations: ChatsMessageProfileProps) => {
...
ChatsMessageProfile.displayName = "ChatsMessageProfile";
export default ChatsMessageProfile;
